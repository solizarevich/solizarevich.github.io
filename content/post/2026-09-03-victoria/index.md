...
![Каждый протокол преобразуется к единой внутренней форме.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/9e8/59f/de3/9e859fde314b0be6715b043efc412fcb.webp)
...
![Логи с одинаковыми полями потока образуют один поток.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/838/664/8ff/8386648ffa61f2cc48f7c7d1fa64b0d5.webp)
...
![Буферизованная пачка сбрасывается в один сегмент в памяти.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/030/088/6b4/0300886b4fc9e7349d6a0c9e3819ba57.webp)
...
![Буфер разделён на шарды по числу ядер процессора, и каждый создаёт собственный сегмент в памяти.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/d2e/4eb/7d7/d2e4eb7d729a61050ff2d26f7708c591.webp)
...
![Раздел содержит данные и в памяти, и на диске.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/947/5a0/5a6/9475a05a6afde6ed42e5b5fd417a9d1d.webp)
...
![Сегменты в памяти объединяются сначала в малые, затем в большие.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/367/f04/991/367f049919bd1bbd9a01721b644b467a.webp)
...
![Блоки сегмента, сгруппированные по потоку.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/7a6/9cf/890/7a69cf8900dac92095d1be2e830534e9.webp)
...
![Три лога: одна запись на строку.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/0d4/ceb/840/0d4ceb840570d3ca6679540df21e4e84.webp)
...
![Те же логи, хранимые по колонкам.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/31c/91c/8bb/31c91c8bbd31a2ec7f77a5cfb8044589.webp)
...
![Метки времени хранятся как одно полное значение и последовательность небольших дельт.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/692/09b/45f/69209b45fb44d8290f231977cd03e8fc.webp)
...
![Файл содержит по одной последовательности дельт на блок.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/0bb/95f/74e/0bb95f74e7a80c3d8cb6847a43779828.webp)
...
![Позиция имени в списке является идентификатором колонки.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/816/93e/f3e/81693ef3e0eacd3b60f4cede531d19fe.webp)
...
![Данные каждой колонки попадают в шард — пару файлов values.binN и bloom.binN.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/af4/4f3/c80/af44f3c807fd7c0221b890df44005b55.webp)
...
![Каждой колонке назначается постоянный шард: pod попадает в values.bin1 блок за блоком.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/a98/e4e/cc1/a98e4ecc1b631141a02dbcd4c13246f8.webp)
...
![Независимые файлы шардов: блок может писать в несколько шардов и не иметь колонки в отдельном шарде.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/a60/5d2/602/a605d2602b667c6e9e80c640c969a883.webp)
...
![Колонка _msg находится в собственном файле: один блоб на блок.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/362/646/5bf/3626465bf161761b9b130240b691214d.webp)
...
![Сначала проверяется фильтр Блума блока; к его значениям ведёт только ответ «возможно».](https://habrastorage.org/r/w1560/getpro/habr/upload_files/ca4/556/034/ca4556034c3c26311ae963e14a8020cb.webp)
...
![Каждому блобу фильтра Блума точно соответствует блоб значений той же пары «блок, колонка».](https://habrastorage.org/r/w1560/getpro/habr/upload_files/230/1df/0c6/2301df0c66a9ecb4f977d265e5b5647c.webp)
...
![Заголовок колонки — небольшая карта файлов значений и фильтра Блума.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/37d/e87/ebb/37de87ebb0725b53a8802c90e6053321.webp)
...
![В columns_header.bin один блоб на блок содержит заголовки его колонок.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/9eb/860/300/9eb860300d61f002040cfc89305137d4.webp)
...
![Индекс для блока сразу находит заголовок колонки, который указывает на данные в файле значений.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/813/2fe/d8e/8132fed8efc90ff5e727295d092bfc4d.webp)
...
![Заголовки блоков сгруппированы в фрагменты, называемые блоками индекса.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/943/ee6/2f9/943ee62f9bb42b2429203b82ceedaae2.webp)
...
![Два уровня сужают поиск ещё до чтения заголовков блоков.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/9ba/036/896/9ba036896149b6dc703b6e0d6dea10ca.webp)
...
![Каждый файл сегмента указывает на следующий: запрос сужается от всего сегмента до нескольких байтов.](https://habrastorage.org/r/w1560/getpro/habr/upload_files/065/393/fc6/065393fc68775f71b9ec43f778f4d551.webp)
