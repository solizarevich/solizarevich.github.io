...
**— не перен**осит внешние маршруты

**— не соеди**няет между собой нулевую и ненулевую область (через него не настраивается virtual-link)

**— не содер**жит ASBR

**Totally stubby areas** (полностью тупиковая область)

**— имеет те же свойст**ва, что и stub areas и вдобавок получает от нулевой области только маршрут по умолчанию
...
**— нулевая обла**сть, связывает между собой все остальные области
